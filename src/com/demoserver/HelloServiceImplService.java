 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://impl.demo.com/", wsdlLocation = "http://localhost:9001/service/helloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://impl.demo.com/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9001/service/helloService?wsdl");
    ...
    public HelloServiceImpl getHelloServiceImplPort() {
        return super.getPort(new QName("http://impl.demo.com/", "HelloServiceImplPort"), HelloServiceImpl.class);
    }
    ...
    public HelloServiceImpl getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.demo.com/", "HelloServiceImplPort"), HelloServiceImpl.class, features);
    }
